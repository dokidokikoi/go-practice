...
func (x *UserDefaultResponse) GetUserDetail() *UserModel {
	if x != nil {
		return x.UserDetail
	}
	return nil
...
func (x *UserDefaultResponse) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_userService_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x6f, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72,
	...
	0x72, 0x6d, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f,
	0x72, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x22, 0x58, 0x0a, 0x13, 0x55, 0x73, 0x65,
	0x72, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x6f, 0x64, 0x65, 0x32, 0x7e, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x35, 0x0a, 0x09, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12,
	0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c,
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x38, 0x0a, 0x0c, 0x55, 0x73, 0x65,
	...
	0x55, 0x73, 0x65, 0x72, 0x44, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_userService_proto_goTypes = []interface{}{
	...
	(*UserDefaultResponse)(nil), // 1: pb.UserDefaultResponse
	(*UserModel)(nil),           // 2: pb.UserModel
}
var file_userService_proto_depIdxs = []int32{
	2, // 0: pb.UserDefaultResponse.UserDetail:type_name -> pb.UserModel
	0, // 1: pb.UserService.UserLogin:input_type -> pb.UserRequest
	0, // 2: pb.UserService.UserRegister:input_type -> pb.UserRequest
	1, // 3: pb.UserService.UserLogin:output_type -> pb.UserDefaultResponse
	1, // 4: pb.UserService.UserRegister:output_type -> pb.UserDefaultResponse
...
type UserServiceClient interface {
	UserLogin(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDefaultResponse, error)
	UserRegister(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDefaultResponse, error)
}
...
func (c *userServiceClient) UserLogin(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDefaultResponse, error) {
...
func (c *userServiceClient) UserRegister(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserDefaultResponse, error) {
	out := new(UserDefaultResponse)
...
type UserServiceServer interface {
	UserLogin(context.Context, *UserRequest) (*UserDefaultResponse, error)
	UserRegister(context.Context, *UserRequest) (*UserDefaultResponse, error)
}
...
func (*UnimplementedUserServiceServer) UserLogin(context.Context, *UserRequest) (*UserDefaultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UserLogin not implemented")
}
func (*UnimplementedUserServiceServer) UserRegister(context.Context, *UserRequest) (*UserDefaultResponse, error) {
